...
import (
	"github.com/KowalskiPiotr98/ludivault/common/repositories"
...
func GetPlatforms() ([]*Platform, error) {
	...
	return repositories.QueryRows(getDatabase(), scanPlatform, query)
}
...
func GetPlatform(id uuid.UUID) (*Platform, error) {
	...
	return repositories.QueryRow(getDatabase(), scanPlatform, query, id)
}
...
func CreatePlatform(platform *Platform) error {
	...
	return repositories.CreateDataWithId(getDatabase(), platform, query, platform.Name, platform.ShortName)
}
...
func UpdatePlatform(platform *Platform) error {
	...
	return repositories.UpdateRow(getDatabase(), query, platform.Id, platform.Name, platform.ShortName)
}
...
func DeletePlatform(id uuid.UUID) error {
	...
	return repositories.DeleteRow(getDatabase(), query, id)
}
